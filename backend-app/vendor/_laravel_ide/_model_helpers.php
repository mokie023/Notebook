...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Journal>|Journal whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Journal>|Journal whereTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Journal>|Journal whereEntry($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Journal>|Journal whereEntryDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Journal>|Journal whereMood($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Journal>|Journal whereCategory($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Journal>|Journal timeout(int $seconds)
     ...
     * @property mixed $note_category_id
     * @property mixed $user_id
     * @property int $id
     * @property-read \App\Models\User $user
     * @property-read \App\Models\NoteCategory $category
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note whereNoteCategoryId($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note whereIsPinned($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<NoteCategory>|NoteCategory whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<NoteCategory>|NoteCategory whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<NoteCategory>|NoteCategory whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<NoteCategory>|NoteCategory whereSlug($value)
     * @method static \Illuminate\Database\Eloquent\Builder<NoteCategory>|NoteCategory whereColor($value)
     * @method static \Illuminate\Database\Eloquent\Builder<NoteCategory>|NoteCategory whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<NoteCategory>|NoteCategory whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<NoteCategory>|NoteCategory newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<NoteCategory>|NoteCategory newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<NoteCategory>|NoteCategory query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<NoteCategory>|NoteCategory timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class NoteCategory extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property integer|null $actual_minutes
     * @property integer $planned_minutes
     * @property mixed $session_type
     * @property mixed $task_id
     * @property mixed $user_id
     * @property int $id
     * @property-read \App\Models\User $user
     * @property-read \App\Models\Task $task
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession whereTaskId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession whereSessionType($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession wherePlannedMinutes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession whereActualMinutes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession whereStartedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession whereEndedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<PomodoroSession>|PomodoroSession timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class PomodoroSession extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Tag>|Tag whereUserId($value)
     ...
     * @property int $id
     * @property-read \App\Models\User $user
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\PomodoroSession> $pomodoroSessions
     * @property-read int|null $pomodoroSessions_count
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Task>|Task whereProgressPercent($value)
     ...
     * @property-read int|null $noteCategories_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Tag> $tags
     * @property-read int|null $tags_count
